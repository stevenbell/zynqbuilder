...
# VITA interface
set_property PACKAGE_PIN AF23 [get_ports vita_cam_clk_pll]
set_property PACKAGE_PIN AF22 [get_ports vita_cam_reset_n]
set_property PACKAGE_PIN AF24 [get_ports {vita_cam_trigger[2]}]
set_property PACKAGE_PIN AG24 [get_ports {vita_cam_trigger[1]}]
set_property PACKAGE_PIN AG25 [get_ports {vita_cam_trigger[0]}]
set_property PACKAGE_PIN V28 [get_ports {vita_cam_monitor[0]}]
set_property PACKAGE_PIN V29 [get_ports {vita_cam_monitor[1]}]
set_property PACKAGE_PIN AC24 [get_ports vita_spi_spi_sclk]
set_property PACKAGE_PIN AD24 [get_ports vita_spi_spi_ssel_n]
set_property PACKAGE_PIN AD23 [get_ports vita_spi_spi_mosi]
set_property PACKAGE_PIN AE23 [get_ports vita_spi_spi_miso]
set_property PACKAGE_PIN AH21 [get_ports vita_cam_clk_out_n]
set_property PACKAGE_PIN AK25 [get_ports vita_cam_sync_n]
set_property PACKAGE_PIN AE21 [get_ports {vita_cam_data_n[0]}]
...
#set_property PACKAGE_PIN AK22 [get_ports {vita_cam_data_p[4]}];
#set_property PACKAGE_PIN AK23 [get_ports {vita_cam_data_n[4]}];
#set_property PACKAGE_PIN AJ23 [get_ports {vita_cam_data_p[5]}];
#set_property PACKAGE_PIN AJ24 [get_ports {vita_cam_data_n[5]}];
#set_property PACKAGE_PIN AF20 [get_ports {vita_cam_data_p[6]}];
#set_property PACKAGE_PIN AG20 [get_ports {vita_cam_data_n[6]}];
#set_property PACKAGE_PIN AK17 [get_ports {vita_cam_data_p[7]}];
