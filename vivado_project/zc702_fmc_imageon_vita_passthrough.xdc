...
#set_property PACKAGE_PIN V17 [get_ports {vita_cam_data_n[5]}];
#set_property PACKAGE_PIN AA16 [get_ports {vita_cam_data_p[6]}];
#set_property PACKAGE_PIN AB16 [get_ports {vita_cam_data_n[6]}];
#set_property PACKAGE_PIN V14 [get_ports {vita_cam_data_p[7]}];
#set_property PACKAGE_PIN V15 [get_ports {vita_cam_data_n[7]}];
...
set_property DIFF_TERM true [get_ports vita_cam_clk_out_*]
set_property DIFF_TERM true [get_ports vita_cam_sync_*]
set_property DIFF_TERM true [get_ports vita_cam_data_*]
