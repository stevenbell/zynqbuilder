...
module sobel_filter_INPUT_STREAM_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    input  wire        TVALID,
...
//------------------------Instantiation------------------
// rs
sobel_filter_INPUT_STREAM_reg_slice #(
    .N       ( 39 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
sobel_filter_INPUT_STREAM_fifo #(
    .DATA_BITS  ( 32 ),
    .DEPTH_BITS ( 4 )
) inter_pix_data_V_fifo (
    .clk        ( ACLK ),
...
assign s_data  = {TDEST[0:0], TLAST[0:0], TUSER[0:0], TSTRB[3:0], TDATA[31:0]};
...
module sobel_filter_INPUT_STREAM_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module sobel_filter_INPUT_STREAM_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
