...
module sobel_filter_OUTPUT_STREAM_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    output wire        TVALID,
    ...
    // User signals
    input  wire [31:0] out_pix_data_V_din,
    output wire        out_pix_data_V_full_n,
    input  wire        out_pix_data_V_write,
    input  wire [3:0]  out_pix_strb_V_din,
...
wire [31:0] out_pix_data_V_dout;
wire [0:0]  out_pix_data_V_empty_n;
wire [3:0]  out_pix_strb_V_dout;
wire [0:0]  out_pix_strb_V_empty_n;
wire [0:0]  out_pix_user_V_dout;
wire [0:0]  out_pix_user_V_empty_n;
wire [0:0]  out_pix_last_V_dout;
wire [0:0]  out_pix_last_V_empty_n;
wire [0:0]  out_pix_tdest_V_dout;
wire [0:0]  out_pix_tdest_V_empty_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [38:0] s_data;
...
//------------------------Instantiation------------------
// rs
sobel_filter_OUTPUT_STREAM_reg_slice #(
    .N       ( 39 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// out_pix_data_V_fifo
sobel_filter_OUTPUT_STREAM_fifo #(
    .DATA_BITS  ( 32 ),
    .DEPTH_BITS ( 4 )
) out_pix_data_V_fifo (
    .clk        ( ACLK ),
...
assign TSTRB  = m_data[35:32];
assign TUSER  = m_data[36:36];
assign TLAST  = m_data[37:37];
assign TDEST  = m_data[38:38];
...
assign s_data  = {out_pix_tdest_V_dout, out_pix_last_V_dout, out_pix_user_V_dout, out_pix_strb_V_dout, out_pix_data_V_dout};
...
module sobel_filter_OUTPUT_STREAM_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module sobel_filter_OUTPUT_STREAM_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
