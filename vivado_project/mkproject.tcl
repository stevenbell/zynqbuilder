...
puts "  mkproject PROJECTNAME PATH IP_VLNV"
...
proc create_root_design { parentCell ip_vlnv } {
  ...
  # Create instance: p_hls_target_hw_output_2_stencil_stream_0, and set properties
  set p_hls_target_hw_output_2_stencil_stream_0 [ create_bd_cell -type ip -vlnv stanford.edu:demosaic:p_hls_target_hw_output_2_stencil_stream:1.0 p_hls_target_hw_output_2_stencil_stream_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins p_hls_target_hw_output_2_stencil_stream_0/p_constant_exterior_2_stencil_update_stream]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M06_AXI [get_bd_intf_pins p_hls_target_hw_output_2_stencil_stream_0/s_axi_axilite_hls_target_hw_output_2_stencil_stream] [get_bd_intf_pins processing_system7_0_axi_periph/M06_AXI]
  ...
  connect_bd_net -net axi_dma_1_s_axis_s2mm_tready [get_bd_pins axi_dma_1/s_axis_s2mm_tready] [get_bd_pins p_hls_target_hw_output_2_stencil_stream_0/p_hw_output_2_stencil_stream_TREADY]
  ...
  connect_bd_net -net p_hls_target_hw_output_2_stencil_stream_0_p_hw_output_2_stencil_stream_TDATA [get_bd_pins dout_padding_concat/In0] [get_bd_pins p_hls_target_hw_output_2_stencil_stream_0/p_hw_output_2_stencil_stream_TDATA]
  connect_bd_net -net p_hls_target_hw_output_2_stencil_stream_0_p_hw_output_2_stencil_stream_TLAST [get_bd_pins axi_dma_1/s_axis_s2mm_tlast] [get_bd_pins p_hls_target_hw_output_2_stencil_stream_0/p_hw_output_2_stencil_stream_TLAST]
  connect_bd_net -net p_hls_target_hw_output_2_stencil_stream_0_p_hw_output_2_stencil_stream_TVALID [get_bd_pins axi_dma_1/s_axis_s2mm_tvalid] [get_bd_pins p_hls_target_hw_output_2_stencil_stream_0/p_hw_output_2_stencil_stream_TVALID]
  ...
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/S01_ARESETN] [get_bd_pins axi_mem_intercon_1/S02_ARESETN] [get_bd_pins fmc_imageon_iic_0/s_axi_aresetn] [get_bd_pins fmc_imageon_vita_color/axi4lite_aresetn] [get_bd_pins p_hls_target_hw_output_2_stencil_stream_0/ap_rst_n] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M06_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_50M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs p_hls_target_hw_output_2_stencil_stream_0/s_axi_axilite_hls_target_hw_output_2_stencil_stream/Reg] SEG_p_hls_target_hw_output_2_stencil_stream_0_Reg
